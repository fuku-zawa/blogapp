...
# chatgptに言われてchromiumのパスを設定
# Capybara.register_driver :selenium_chrome do |app|
#   Capybara::Selenium::Driver.new(app, browser: :chrome, options: { binary: '/usr/bin/chromium-browser' })
# end

  # Capybara.register_driver :selenium_chrome_headless do |app|
  #   capabilities = Selenium::WebDriver::Remote::Capabilities.chrome(
  #     chrome_options: { args: %w(headless disable-gpu window-size=1920,1080) }
  #   )
